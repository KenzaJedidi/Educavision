...
class Candidature
{
    ...
    #[ORM\ManyToOne(targetEntity: OffreStage::class, fetch: 'LAZY')]
    ...
    public function getOffreStage(): ?OffreStage { return $this->offreStage ?? null; }
    ...
    public function getNoteAdmin(): ?int { return $this->noteAdmin ?? null; }
    public function setNoteAdmin(?int $noteAdmin): self { $this->noteAdmin = $noteAdmin; return $this; }

    public function getCommentaireAdmin(): ?string { return $this->commentaireAdmin ?? null; }
